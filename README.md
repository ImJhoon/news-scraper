...
* **마크다운(Markdown) 리포트 자동 생성**: 수집된 뉴스를 모바일과 PC 모두에서 가독성이 뛰어난 카드(Card)형 인용구 구조로 예쁘게 가공하여 보여줍니다.
* **스마트 썸네일 추출(웹 크롤링)**: 각 기사 원문 페이지의 HTML을 분석해 OG(Open Graph) 태그 이미지를 자동으로 추출하여 시각적인 즐거움을 더합니다.
